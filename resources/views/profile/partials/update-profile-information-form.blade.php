<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="gsq" name="gsq" type="text" class="mt-1 block w-full" :value="old('gsq', $user->gsq)" required autofocus autocomplete="gsq" />
            <x-input-error class="mt-2" :messages="$errors->get('gsq')" />
        </div>

        <div>
            <x-input-label for="qrz_api_key" :value="__('QRZ API Key')" />
            <x-text-input id="qrz_api_key" name="qrz_api_key" type="password" class="mt-1 block w-full" :value="old('qrz_api_key', $user->qrz_api_key)" required autofocus autocomplete="qrz_api_key" />
            <x-input-error class="mt-2" :messages="$errors->get('qrz_api_key')" />
        </div>
