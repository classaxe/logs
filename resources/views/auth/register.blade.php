<x-app-layout>
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg" style="margin: 0 auto">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Email Address -->
            <div class="mt-4">
                <x-input-label for="email" :value="__('* Email (Valid address, all lower-case)')" />
            ...
            <!-- Gridsquare -->
            <div class="mt-4">
                <x-input-label for="gsq" :value="__('* Maidenhead GSQ (6 or 8 chars)')" />
                <x-text-input id="gsq" class="block mt-1 w-full" type="text" name="gsq" maxlength="8" :value="old('gsq')"
                  pattern="^(?:[a-rA-R]{2}[0-9]{2}[a-xA-X]{2}|[a-rA-R]{2}[0-9]{2}[a-xA-X]{2}[0-9]{2})$"
                  required autocomplete="gsq" />
            ...
            <!-- Password -->
            <div class="mt-4">
                <x-input-label for="password" :value="__('* Password (8 chars min)')" />
