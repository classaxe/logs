        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <ol>
                        <li><b>IFRAME Embedding -
                            <a href="{{ $urlIframe }}" target="_blank" style="color:#00f; text-decoration: underline">Link</a></b>
...
<iframe src="{{ $urlIframe }}" title="Live logs for {{ $user->call }}"
style="width:740px; height: 360px; border:none"></iframe>
</textarea>
                        </li>
                        <li><b>Javascript Embedding -
                            <a href="{{ $urlJs }}" target="_blank" style="color:#00f; text-decoration: underline">Link</a></b>
